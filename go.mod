module github.com/armory-io/potato-facts

go 1.19

require (
	github.com/armory-io/go-commons v1.32.2
...
require (
	...
	go.opentelemetry.io/contrib/instrumentation/github.com/gin-gonic/gin/otelgin v0.36.1 // indirect
